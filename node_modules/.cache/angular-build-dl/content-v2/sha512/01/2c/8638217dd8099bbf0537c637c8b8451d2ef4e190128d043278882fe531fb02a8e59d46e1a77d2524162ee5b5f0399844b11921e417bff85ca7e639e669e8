    ...
    function zpKS(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomePage = /*#__PURE__*/function () {
        ...
        _createClass(HomePage, [{
          ...
          key: "viewcase",
          value: function viewcase(issues) {
            this.router.navigateByUrl('/viewcase', {
              state: issues
            });
          }
        }, {
          ...
          value: function getIssues() {
            ...
            this.data.getProblem().then(function (items) {
              _this2.issues = items;
              console.log(_this2.issues);
            });
          }
        }]);
